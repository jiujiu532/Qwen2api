    ...
    <div className="flex min-h-screen w-full bg-background text-foreground transition-colors duration-500 overflow-hidden font-sans">
      ...
      >
        ...
        <div className="px-6 pb-4">
          <div className="flex items-center justify-center gap-2 h-9 rounded-2xl bg-indigo-500/10 text-indigo-400 text-[11px] font-medium">
            <span>V2.0.0</span>
            <a href="https://github.com/jiujiu532/Qwen2api" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-300 transition-colors" title="GitHub">
